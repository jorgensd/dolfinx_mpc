...
def assemble_cells(b: 'numpy.ndarray[PETSc.ScalarType]',
                   ...
                   mpc: Tuple['numpy.ndarray[numpy.int32]', 'numpy.ndarray[PETSc.ScalarType]',
                              ...
                              'numpy.ndarray[numpy.int32]', 'numpy.ndarray[numpy.int32]']):
    """
    Assemble additional MPC contributions for cell integrals into a vector
...
def assemble_exterior_slave_facets(b: 'numpy.ndarray[PETSc.ScalarType]',
    ...
    """
    Assemble additional MPC contributions for facets into a vector
...
def modify_mpc_contributions(b: 'numpy.ndarray[PETSc.ScalarType]', cell_index: int,
    ...
    b
        The vector to assemble into
    cell_index
        Index (local to process) of the cell to modify
    b_local
        Local vector with contributions from integration kernel
    b_copy
        Copy of `b_local`
    mpc
        Data from `dolfinx_mpc.MultiPointConstraint` flattened as arrays
    dofmap
        Dofmap for function space (not expanded for `block_size`)
    block_size
        The block size of the function space
    num_dofs_per_element
        The number of degrees of freedom per element (not multiplied by `block_size`).
    """
