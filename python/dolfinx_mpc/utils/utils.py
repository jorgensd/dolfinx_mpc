...
def facet_normal_approximation(V, mt, mt_id, tangent=False, jit_parameters: dict = {},
...
"""
    ...
    bilinear_form = _fem.form(a, jit_parameters=jit_parameters,
    ...
    A.assemble()
    linear_form = _fem.form(L, jit_parameters=jit_parameters,
                            form_compiler_parameters=form_compiler_parameters)
    b = _fem.assemble_vector(linear_form)
